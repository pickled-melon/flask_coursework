...
def future_page():
    items = [
        {"img_link": '/static/images/climate_change.png', "img_alt": 'Изменение климата', "img_title": 'Изменение климата', "title": 'Изменение климата', "text": 'Мировой банк активно работает над проектами, направленными на борьбу с <a href="/glossary#Climate_change">изменением климата</a> и его последствиями. Он стремится финансировать устойчивые проекты и поддерживать страны в адаптации к новым климатическим условиям.'},
        {"img_link": '/static/images/cooperation.png', "img_alt": 'Частный сектор', "img_title": 'Сотрудничество с частным сектором', "title": 'Сотрудничество с частным сектором', "text": 'Мировой банк ищет новые способы сотрудничества с частным сектором для привлечения <a href="/glossary#Investment">инвестиций</a> и инноваций в проекты развития.'},
        {"img_link": '/static/images/accountability.png', "img_alt": 'Отчетность', "img_title": 'Улучшение прозрачности и отчетности', "title": 'Улучшение прозрачности и отчетности', "text": 'В ответ на критику, Мировой банк работает над повышением прозрачности своих операций и улучшением механизмов контроля.'},
    ]
